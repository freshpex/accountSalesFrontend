...
const LandingPage = lazy(
  () =>
    import(/* webpackChunkName: "landing" */ "../pages/landingPage/index.jsx"),
);
const Login = lazy(
  () =>
    import(
      /* webpackChunkName: "auth" */ "../app/authentication/login/index.jsx"
    ),
);
const Register = lazy(
  () =>
    import(
      /* webpackChunkName: "auth" */ "../app/authentication/register/index.jsx"
    ),
);
const Dashboard = lazy(
  () =>
    import(/* webpackChunkName: "dashboard" */ "../app/dashboard/index.jsx"),
);
const Help = lazy(() => import("../app/help/index.jsx"));
const AccountSettings = lazy(
  () => import("../app/accountSettings.jsx/index.jsx"),
);
...
const ResetPassword = lazy(
  () => import("../app/authentication/ForgotPassword/ResetPassword.jsx"),
);
const EmailInfo = lazy(
  () => import("../app/authentication/ForgotPassword/EmailInfo.jsx"),
);
const ChangePassword = lazy(
  () => import("../app/authentication/ForgotPassword/changePassword.jsx"),
);
const ProductDetail = lazy(
  () =>
    import(
      /* webpackChunkName: "product-detail" */ "../app/product/pages/ProductDetail.jsx"
    ),
);
const PaymentCallback = lazy(
  () => import("../app/payment/PaymentCallback.jsx"),
);
const EscrowDetails = lazy(
  () =>
    import(
      /* webpackChunkName: "escrow" */ "../app/product/pages/EscrowDetails.jsx"
    ),
);
const UserDashboard = lazy(
  () => import("../app/userDashboard/UserDashboard.jsx"),
);
const Privacy = lazy(() => import("../pages/legal/Privacy.jsx"));
const Terms = lazy(() => import("../pages/legal/Terms.jsx"));
const PurchasedAccountDetails = lazy(
  () =>
    import(
    ...
    <Suspense fallback={<SuspenseLoadingUI />}>
      <Routes>
        ...
        >
          ...
          <Route
            path="/purchased-account/:purchaseId"
            element={<PurchasedAccountDetails />}
          />
        </Route>

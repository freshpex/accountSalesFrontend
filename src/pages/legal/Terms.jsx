...
const Terms = () => {
  ...
  return (
    <Box>
      {/* Hero Section */}
      <Box bg={useColorModeValue("blue.50", "blue.900")} py={20} px={4} mb={8}>
            ...
            <Accordion allowMultiple>
              {termsItems.map((item, index) => (
                <AccordionItem
                  ...
                  overflow="hidden"
                >
                  <AccordionButton p={4} _hover={{ bg: highlightColor }}>
        ...
        <ModalContent>
          ...
          <ModalBody pb={6}>
            <VStack spacing={4} align="stretch">
              <Text>
                Choose your preferred format to download the complete Terms &
                Conditions document:
              </Text>

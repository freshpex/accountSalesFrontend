...
export default function NormalSearchBar() {
  ...
  return (
    <form className="bg-neutral-100 text-neutral-900 | py-1 pl-6 pr-3 | border-2 border-solid border-neutral-400 rounded-full | flex justify-between | focus-within:border-primary | transition-colors">
      <input
        onChange={debounce((e) => handleSearch(e), 1000)}
        type="text"
        placeholder="Search"
        className="grow | border-none outline-none | placeholder:text-neutral-500"
      />

      <button type="button" className="p-[7px] | grid place-content-center">
        {searchImg}
      </button>
    </form>
  );

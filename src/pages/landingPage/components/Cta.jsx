        ...
        <div className="flex max-tablet:flex-col items-center gap-12">
          ...
          >
            ...
            <p className="text-neutral-600 text-500 leading-relaxed">
              Access a marketplace of verified social media accounts. Whether
              you`re looking to purchase an established Instagram, TikTok,
              YouTube, or other social media presence, we provide secure
              transactions and verified accounts with real followers.
            </p>

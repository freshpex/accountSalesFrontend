          ...
          >
            <div>
              ...
              <p className="text-600 text-neutral-600 leading-relaxed | max-w-[470px] mb-10">
                Secure marketplace for verified social media accounts. Purchase
                established accounts with real followers. Instagram, TikTok,
                YouTube, Facebook, and WhatsApp Business accounts available.
              </p>
            ...
            <div className="grow | space-y-6 | mobile-lg:max-w-[400px]">
              <div className="grid grid-cols-[repeat(auto-fill,_minmax(120px,_1fr))] gap-4">
                <div>
                  <p className="text-900 text-neutral-900 font-bold font-['Integral_CF',_sans-serif] leading-tight">
                    50K+
                  </p>
                  <p className="text-600 text-neutral-600 leading-relaxed">
                    Accounts Sold
                  </p>
                </div>
                <div>

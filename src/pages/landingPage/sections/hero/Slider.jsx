...
export default function Slider({
  smallerDeviceExtraClasses,
  largerDeviceExtraClasses,
}) {
  return (
    <>
      <motion.div
      ...
      >
        {sliderData.map(
          ({ title, ownerImg, ownerName, nftImg, price, timeLeft }, index) => (
            <motion.div
            ...
            >
              <div className="space-y-2 | relative">
                <h3 className="text-700 font-bold leading-tight tracking-tight">
                  {title}
                </h3>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-500 font-medium leading-tight">
                    {ownerName}
                  </p>
                </div>
              </div>
              ...
              <div className="relative | flex flex-col min-[915px]:flex-row justify-center min-[915px]:justify-between text-center min-[915px]:text-start items-center gap-4 rounded-xl bg-neutral-100/20 backdrop-blur-xl p-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between gap-1">
                    ...
                    <p className="text-400 font-medium leading-tight">
                      {price} Naira
                    </p>
                  </div>
                </div>
              ...
              <div className="w-20 h-20 min-[915px]:w-28 min-[915px]:h-28 | absolute top-1/2 left-1/2 -mt-10 -ml-10 min-[915px]:-mt-14 min-[915px]:-ml-14 z-[5] animate-spin-slow">
                <Picture
                  src={nftBadge}
                  alt="live auction badge for the nft"
                  extraClasses=""
                />
              </div>
            </motion.div>
      ...
      >
        ...
        >
          {sliderData.map(
            (
              { title, ownerImg, ownerName, nftImg, price, timeLeft },
              index,
            ) => (
              <SwiperSlide
                key={index}
              ...
              >
                ...
                >
                  <div className="space-y-2 | relative">
                    <h3 className="text-800 font-bold leading-tight tracking-tight cursor-pointer">
                      {title}
                    </h3>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <p className="text-600 font-medium leading-tight">
                        {ownerName}
                      </p>
                    </div>
                  </div>

...
export default function ResourceNftCard({ item }) {
  const { img, avatar, title, price, nftNumber, totalNftNumber, timeLeft } =
    item || {};
  return (
    <div
      aria-label="nft card"
    ...
    >
      ...
      <div className="px-3.5 pt-6">
        <p className="text-neutral-900 text-600 font-bold leading-5 mb-[10px] cursor-pointer">
          {title}
        </p>
        ...
        <div className="flex items-center justify-between gap-4 mb-[18px]">
          <div className="flex items-center gap-1">
            ...
            <p className="text-200 font-bold text-accent-400 leading-tight">
              {price} Naira
            </p>
          </div>

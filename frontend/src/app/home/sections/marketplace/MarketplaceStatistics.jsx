                        ...
                        <motion.li
                            ...
                            <div className="flex items-center justify-start gap-5 | before:[content:counter(count)] before:text-700 before:font-bold before:leading-[100%] before:tracking-tight before:w-4 before:flex before:justify-center before:items-center">
                                ...
                                <div className="space-y-3">
                                    <p className="text-500 font-semibold text-neutral-900 leading-[100%] tracking-tight cursor-pointer">{nftName}</p>

                                    <div className="flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="16" viewBox="0 0 10 16" fill="#3A3A3A">
                                        <g>
                                            <path d="M1 2V14M9 2V14M3 6H7M3 10H7M2 2L8 14M8 2L2 14" stroke="#3A3A3A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                        </g>
                                    </svg>

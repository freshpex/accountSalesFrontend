...
export default function MobileMenu({ isMobileMenuVisible, setIsMobileMenuVisible, offCanvasExtraClasses, offCanvasBackdropExtraClasses, sidebarRef }) {
    return (
        <>
            ...
            {/* backdrop effect */}
            <div className={`fixed top-0 left-0 z-30 | bg-neutral-900 w-screen h-screen | ${isMobileMenuVisible ? "visible opacity-50" : "invisible opacity-0 overflow-hidden"} | transition-all duration-300 | ${offCanvasBackdropExtraClasses}`}>
